"""
SVISE Final Evaluation: All Active 5-Minute Chunks from Synthetic Noiseless Data.
...
def load_synthetic_data(data_path):
    """Load synthetic data and chunk into 5-minute windows, filtering dead chunks."""
...
def main():
    ...
    print(f"\n{'=' * 60}")
    print(f"SVISE FINAL EVALUATION — SYNTHETIC NOISELESS")
    print(f"{'=' * 60}")
    ...
    # Output directory
    results_base = os.path.join(script_dir, "results_synthetic_noiseless")
    if args.run_name:
    ...
    print(f"\n{'=' * 60}")
    print(f"EVALUATION COMPLETE — Synthetic Noiseless [{start}, {end}]")
    print(f"{'=' * 60}")
