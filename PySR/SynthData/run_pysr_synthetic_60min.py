"""
PySR Per-Chunk Training – Synthetic Dataset (60-min chunks)
===========================================================
Trainiert PySR auf jedem gültigen 60-min Chunk des synthetischen Datensatzes.
...
OUT_DIR    = "/home/ka/ka_iai/ka_hr7224/synthetic_dataset_validation/results_synthetic_noise/60minNewParam/"
CHUNK_SIZE = 3600   # 60 min * 60 sec * 1 Hz
...
def get_valid_chunks(data: pd.DataFrame) -> list:
    print(f"Splitting into {CHUNK_SIZE}-sample (60-min) chunks ...")
...
def simulate_chunk(t_arr, theta0, omega0, dyn_func, max_seconds=30):
    """60-min Chunks brauchen mehr Zeit für die ODE-Simulation."""
    import time
...
def main():
    parser = argparse.ArgumentParser(
        description="PySR full training – Synthetic 60-min chunks"
    )
