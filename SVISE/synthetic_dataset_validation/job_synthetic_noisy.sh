#!/bin/bash
#SBATCH --job-name=svise_noisy
#SBATCH --time=48:00:00
#SBATCH --partition=cpu
#SBATCH --output=./slurm-logs-synthetic-noisy/%x-%A_%a.out
...
mkdir -p ./slurm-logs-synthetic-noisy
...
python -u run_svise_synthetic_noisy.py --start-chunk $START_CHUNK --end-chunk $END_CHUNK --run-name ${RUN_NAME}
