#!/bin/bash
#SBATCH --job-name=sindy_s1h
#SBATCH --time=48:00:00
#SBATCH --partition=cpu
#SBATCH --output=./slurm-logs-synthetic-all-chunks-1h/%x-%A_%a.out
...
mkdir -p ./slurm-logs-synthetic-all-chunks-1h
...
python -u run_sindy_synthetic_all_chunks_1h.py \
